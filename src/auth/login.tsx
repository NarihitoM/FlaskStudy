...
import { Check, X, Mail, Lock, EyeOff, Eye } from "lucide-react";
        ...
        if (!useremail) {
            ...
            try {
                ...
                if (result && result.success) {
                    ...
                    setnewmessage(result.message || "Login Successful")
                ...
                <div className="fixed top-1/2 z-1000 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-auto">
                    {loading ?
                        ...
                        (< Card >
                            ...
                            <CardContent>
                                {newmessage === "Login Successful" ? <p className="text-green-600">{newmessage}</p> : <p className="text-red-600">{newmessage}</p>}
                            </CardContent>
                ...
                <Card className="h-auto px-8">
                    <CardHeader >
                        ...
                        <CardDescription className="text-center fond-bold">
                            We are thrilled to see you back!
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handlesubmit}>
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex flex-row justify-between w-full gap-8">
                                    <button type="button" onClick={() => navigate("/")} className="bg-black w-full rounded-lg p-2 text-[14px] font-medium text-white hover:bg-gray-600 mt-2 active:translate-y-1">
                                        Back
                                    </button>
                                </div>
                            </div>
                    ...
                    <CardFooter className="flex flex-col gap-2">
                        <div className="flex flex-row justify-between gap-8">
                            <h1 className="text-[14px]">Don't have an account?</h1>
                            <NavLink className="text-[14px] text-blue-600" to="/signup">Sign Up</NavLink>
                        </div>
