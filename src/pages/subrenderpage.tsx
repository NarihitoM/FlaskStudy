...
const Subrenderpage = () => {
    ...
    return (
        <>
            <div className="fixed top-0 left-0 p-3 bg-white w-full z-50 border-t shadow-md md:hidden">
            ...
            <SidebarProvider open={open} defaultOpen={true} onOpenChange={() => setopen(prev => !prev)}>
                <div className="flex flex-row">
                    ...
                    <main className="flex flex-col w-full h-screen overflow-auto p-3" style={{ scrollbarWidth: "none" }}>
                        <div className="flex w-full flex-wrap gap-5  rounded-lg p-5 max-md:pt-30 max-md:pb-30">
                            <Outlet />
                        </div>
                    </main>
                    <div className="fixed bottom-0 left-0  right-0 z-50 bg-white border-t shadow-md md:hidden">
                        <div className="flex justify-evenly py-2">
                            {studyelement(title!).map((item, idx) => {
