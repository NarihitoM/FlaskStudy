...
const MCQ = () => {
    ...
    {/*fetching the data from backend via token key */ }
    useEffect(() => {
        setisfetching(true);
    ...
    {/*cant find question toggle this*/}
            ...
            {questionlist.length > 0 &&
                <div className="flex flex-col items-center w-full justify-center gap-6 py-10">
                    <div className="bg-yellow-600 p-8  w-[1000px] max-md:w-[300px] max-w-full rounded-lg">
                        <p className="text-white font-bold"> <div dangerouslySetInnerHTML={{ __html: questionlist[currentindex].question || "" }} /></p>
                    </div>
                    <div className="flex flex-col w-[1000px] max-md:w-[300px]  justify-center items-center gap-5">
                        {questionlist[currentindex].choices.map((element, index) => {
                            ...
                            return (<div className={`${selectedIndex === null
                                ...
                                : isanswer
                                    ...
                                    : isselect
                                        ...
                                        : "bg-white opacity-60"
                                } shadow-lg p-3 rounded-lg w-full font-medium transition-all`} onClick={() => selectedIndex === null && setSelectedIndex(index)} key={index}>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button disabled={currentindex === questionlist!.length - 1} className="flex flex-row gap-1 text-white bg-yellow-700 rounded-lg p-2 active:translate-y-1 disabled:opacity-50" onClick={nextpage}><ArrowRight></ArrowRight>Next</button>
                    </div>
